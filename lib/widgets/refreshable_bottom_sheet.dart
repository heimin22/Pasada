...
/// A refreshable bottom sheet that can update its content without reopening
class RefreshableBottomSheet extends StatefulWidget {
  ...
  /// Show the refreshable bottom sheet
  static Future<RefreshableBottomSheetState?> showRefreshableBottomSheet({
    ...
    return showModalBottomSheet<RefreshableBottomSheetState>(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (BuildContext context) {
        return RefreshableBottomSheet(
  ...
  @override
  State<RefreshableBottomSheet> createState() => RefreshableBottomSheetState();
}

class RefreshableBottomSheetState extends State<RefreshableBottomSheet> {
  bool _isRefreshing = false;
  int _refreshKey = 0; // Key to force rebuild

  /// Show skeleton loading and refresh content
  ...
  /// Force content refresh without skeleton
  void forceRefresh() {
    setState(() {
      _refreshKey++;
    });
